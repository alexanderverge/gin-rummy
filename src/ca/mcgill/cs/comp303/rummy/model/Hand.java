...
public class Hand implements Serializable
{
	...
	/**
	 * Update cards contained in the unmatched structure.
	 * @param allCards The currently unmatched cards.
	 */
	...
	/**
	 * Update cards contained in the unmatched structure.
	 * @param pCards Cards that have matches.
	 */
	...
	/**
	 * Check if Cards are unmatched.
	 * @param pCards Cards under consideration.
	 * @return True if the Cards are unmatched.
	 */
	...
	/**
	 * Obtain a list of all (matched or unmatched) Cards.
	 * @return
	 */
